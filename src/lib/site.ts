...
export const STATS = [
  { value: 1, suffix: "", label: "Studio (Beruwala)" },
...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    address: "45 Galle Road, Beruwala",
    city: "Beruwala",
    ...
    items: [
      {
        id: 1,
        name: "Balmain Paris White Logo Tee",
        qty: 1,
        price: 18500,
        image: "/images/symi-balmain-paris-white-logo-tee.jpg",
      },
      {
        id: 3,
        name: "Lattafa Bint Hooran EDP Perfume 100ml",
        qty: 1,
        price: 19900,
        image: "/images/symi-lattafa-bint-hooran-perfume.jpg",
      },
  ...
  },
  {
    ...
    address: "12 Beach Road, Beruwala",
    city: "Beruwala",
    total: 7850,
    status: "Processing",
  ...
  },
  {
    ...
    address: "88 Main Street, Beruwala",
    city: "Beruwala",
    total: 8950,
    status: "Pending",
